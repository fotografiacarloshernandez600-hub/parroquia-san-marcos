...
export const TABLAS = {
  ...
  calendario_liturgico: {
    ...
    campos: {
      ...
      titulo: { label: 'Título / celebración', tipo: 'text', requerido: true },
      descripcion: { label: 'Descripción', tipo: 'textarea' },
      color_liturgico: { label: 'Color litúrgico', tipo: 'select', opciones: COLORES_LITURGICOS },
      imagen: { label: 'Imagen (opcional)', tipo: 'image', carpeta: 'calendario' },
      orden: { label: 'Orden', tipo: 'number' },
    },
    columnasLista: ['fecha', 'titulo', 'color_liturgico'],
  },
